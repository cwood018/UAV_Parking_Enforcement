...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt('/Users/christopherwood/PycharmProjects/ProjectFinal/classifications.txt', np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt('/Users/christopherwood/PycharmProjects/ProjectFinal/flattened_images.txt', np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
