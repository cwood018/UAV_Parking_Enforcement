<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TicketTimeReport.aspx.cs" Inherits="Capstone_UI.TicketTimeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <title>Ticket Time Report</title>
        <center><asp:Label ID="ReportTitleLabel" runat="server" style="text-align: left; font-size: x-large;" Text="Tickets Within Time Range Report"></asp:Label></center>
        <br />
        <br />
        <br />
        <div style="width: 1044px">          
            <asp:Label ID="TicketIDLabel" runat="server" Text="Ticket Number"></asp:Label>
            <asp:TextBox ID="TicketIDTextBox" runat="server"></asp:TextBox>
            <asp:Label ID="PlateNumLasbel" runat="server" Text="Plate Number"></asp:Label>
            <asp:TextBox ID="PlateNumTextBox" runat="server"></asp:TextBox>
...
&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:GridView ID="TicketTimeGridView" runat="server" Width="100%" ShowHeaderWhenEmpty="True" AllowPaging="True" AutoGenerateSelectButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="ticket_number,plate_number" OnPageIndexChanging="TicketTimeGridView_PageIndexChanging" PageSize="5" >
        ...
        <div>
            ...
            <asp:FormView ID="TicketTimeFormView" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Both" Width="100%">
                <EditItemTemplate>
                    ticket_number:
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:capstone_finalConnectionString %>" SelectCommand="SELECT * FROM [TicketsofUsersInfoView] WHERE ([ticket_number] = @ticket_number)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="TicketTimeGridView" Name="ticket_number" PropertyName="SelectedValue" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
            </div>
